/*
 ...
 Date: 25/03/2024 16:07:45
*/
DROP DATABASE IF EXISTS xmall ;
CREATE DATABASE xmall CHARACTER SET utf8;
use xmall ;
SET NAMES utf8mb4;
...
INSERT INTO `address` VALUES (5, '小李', '小学门口', '16588745587', 11);
...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES (1, '希望之线（东野圭吾新代表作，高分作品TOP5！）', '《白夜行》《嫌疑人X的献身》《解忧杂货店》《恶意》后，豆瓣东野圭吾第五高分新作！好看到爆炸的人情推理长篇。上市首周登顶日本畅销书总榜，周刊文春推理榜年度推荐。', 'g1001', 35.00, 0.90, 996, 3, 4, 1, '[\"http://localhost:9999/files/1622098971802\",\"http://localhost:9999/files/1622098971804\",\"http://localhost:9999/files/1622098971807\"]', NULL, 1);
...
INSERT INTO `goods` VALUES (4, '文城（余华新书，时隔8年重磅归来，《活着》之后又一精彩力作！）', '余华时隔8年重磅新作！写《活着》的余华又回来了！人生就是自己的往事和他人的序章。关于一个人和他一生的寻找，以及一群人和一个汹涌的年代。精彩过瘾，不负等待！易烊千玺挚爱作家。限量赠送余华珍藏生肖漫画！', 'g1004', 39.50, 0.90, 994, 0, 6, 1, '[\"http://localhost:9999/files/1622092112546\"]', '2021-05-26 07:46:19', 1);
...
INSERT INTO `order_goods` VALUES (16, 11, 4, 1);
INSERT INTO `order_goods` VALUES (17, 11, 1, 1);
INSERT INTO `order_goods` VALUES (18, 12, 1, 1);
...
INSERT INTO `t_log` VALUES (301, '用户 tom 登录系统', '2024-03-25 13:43:16', 'tom', '0:0:0:0:0:0:0:1');
INSERT INTO `t_log` VALUES (302, '更新用户：tom ', '2024-03-25 13:44:53', 'tom', '0:0:0:0:0:0:0:1');
INSERT INTO `t_log` VALUES (303, '更新用户账户：tom ', '2024-03-25 13:45:28', 'tom', '0:0:0:0:0:0:0:1');
INSERT INTO `t_log` VALUES (304, '用户 admin 登录系统', '2024-03-25 14:08:37', 'admin', '0:0:0:0:0:0:0:1');
INSERT INTO `t_log` VALUES (305, '用户 admin 登录系统', '2024-03-25 16:05:31', 'admin', '0:0:0:0:0:0:0:1');
INSERT INTO `t_log` VALUES (306, '用户 tom 登录系统', '2024-03-25 16:05:45', 'tom', '0:0:0:0:0:0:0:1');
...
-- Records of t_notice
-- ----------------------------
INSERT INTO `t_notice` VALUES (1, '好好学习，天天向上', '敲代码', '2021-04-16 17:10:44');
INSERT INTO `t_notice` VALUES (2, '程序员之家', '一起交流学习', '2021-04-16 17:54:10');
...
INSERT INTO `t_order` VALUES (11, '20240325140444133024', 67.05, 11, '小李', '16588745587', '小学门口', '待发货', '2024-03-25 14:04:44');
INSERT INTO `t_order` VALUES (12, '20240325160600537158', 31.50, 11, '小李', '16588745587', '小学门口', '待发货', '2024-03-25 16:06:00');
...
INSERT INTO `t_user` VALUES (11, 'tom', '123456', '汤姆', 'tom@qq.com', '13685249632', '1711345493705', '[2]', '上海', 20, 9901.45);
